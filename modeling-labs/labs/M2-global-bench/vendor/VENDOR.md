...
本 lab **M2-global-bench** 编译使用本目录；正本在下列前序 lab 的 `src/`。
...
- 来自 `C3-sa/src`: sa.h, sa.c, bench_sa.h, bench_sa.c
- 来自 `C5-ga-de/src`: de.h, de.c
- 来自 `C6-es-cmaes/src`: cmaes.h, cmaes.c, es.h, es.c
- 来自 `C7-pso-aco/src`: pso.h, pso.c
